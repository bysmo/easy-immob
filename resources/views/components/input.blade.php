...
@php
$baseClasses = 'block w-full rounded-xl border text-sm transition-all duration-150 shadow-2xs px-3.5 py-2.5 outline-none placeholder:text-slate-400 dark:placeholder:text-slate-500 disabled:opacity-60 disabled:bg-slate-100 dark:disabled:bg-slate-800 disabled:cursor-not-allowed';
...
<div class="relative w-full">
    ...
    <input {{ $attributes->merge(['class' => "$baseClasses $stateClasses $paddingClasses"]) }}>
