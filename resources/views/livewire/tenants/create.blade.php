<div class="max-w-2xl space-y-5">
    <div class="flex items-center gap-3">
        ...
        <h1 class="text-xl font-semibold text-gray-900 dark:text-gray-100">Nouveau locataire</h1>
    </div>
        ...
        <form wire:submit="save" class="space-y-4">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <x-input wire:model="first_name" type="text" id="first_name" placeholder="Marc" autofocus />
                    @error('first_name') <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p> @enderror
                </div>

                <div>
                    <x-label for="last_name">Nom</x-label>
                    <x-input wire:model="last_name" type="text" id="last_name" placeholder="Kouassi" />
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <x-input wire:model="email" type="email" id="email" placeholder="marc.kouassi@example.com" />
                    @error('email') <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p> @enderror
                </div>

                <div>
                    <x-label for="phone">Téléphone</x-label>
                    <x-input wire:model="phone" type="text" id="phone" placeholder="+225 05 00 00 00 00" />
            ...
            <div>
                ...
                <x-input wire:model="address" type="text" id="address" placeholder="Marcory Zone 4, Abidjan" />
            ...
            <div>
                ...
                <x-input wire:model="emergency_contact" type="text" id="emergency_contact" placeholder="Kouassi Paul (Frère) - +225 01 00 00 00 00" />
