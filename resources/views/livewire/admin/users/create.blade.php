<div class="max-w-3xl mx-auto space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200/80 dark:border-slate-800 pb-4">
        <div>
            ...
            <h1 class="text-2xl font-bold tracking-tight text-slate-900 dark:text-white">Créer un membre d'équipe</h1>
            <p class="text-xs text-slate-500 dark:text-slate-400">Attribuez des autorisations d'accès au personnel de votre agence.</p>
        </div>
    </div>
        ...
        <x-card>
            ...
            <div class="space-y-5">
                <div>
                    ...
                    <x-input wire:model="name" type="text" id="name" placeholder="Ex: Marie Dubois" autofocus icon="user" :error="$errors->first('name')" />
                </div>

                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div>
                        <x-label for="email" :required="true">Adresse Email</x-label>
                        <x-input wire:model="email" type="email" id="email" placeholder="marie@agence.com" icon="notifications" :error="$errors->first('email')" />
                    </div>
        ...
        <x-card>
            <div class="flex items-center gap-3 pb-4 mb-5 border-b border-slate-100 dark:border-slate-800">
                ...
                <div>
                    ...
                    <p class="text-xs text-slate-500">Définissez les identifiants d'accès temporaires.</p>
                </div>
            </div>

            <div class="space-y-5">
                <div>
                    <x-label for="password" :required="true">Mot de passe temporaire</x-label>
