<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200/80 dark:border-slate-800 pb-4">
        <div>
            ...
            <p class="text-xs text-slate-500 dark:text-slate-400">Mettre à jour les informations et spécifications de ce bien.</p>
        </div>
    </div>
    ...
    <form wire:submit="save" class="space-y-6">
        ...
        <!-- Section 4 : Historique des révisions et augmentations de loyer -->
        <x-card>
