<div class="max-w-4xl mx-auto space-y-6">
    ...
    <form wire:submit="save" class="space-y-6">
            ...
            <div class="space-y-5">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div>
                        ...
                        <x-input wire:model.live="rent_amount" type="number" step="1000" id="rent_amount" placeholder="250000" icon="wallet" :error="$errors->first('rent_amount')" />
                    </div>
        ...
        <!-- Section 5 : Fiscalité IRF, Commission Agence & Récapitulatif Financier -->
        <x-card>
            <div class="flex items-center gap-3 pb-4 mb-5 border-b border-slate-100 dark:border-slate-800">
