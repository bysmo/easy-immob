...
class DepositTest extends TestCase
{
    ...
    public function test_lease_has_deposits_relationship(): void
    {
        $agency = Agency::factory()->create();
        $lease  = \App\Domain\Lease\Models\Lease::factory()->for($agency, 'agency')->create([
        ...
        $this->assertTrue($lease->deposits->contains($deposit));
    }

    public function test_deposits_index_page_can_be_rendered(): void
    {
        $agency = Agency::factory()->create();
        $user   = User::factory()->for($agency, 'agency')->create();
        $user->givePermissionTo(['deposits.view', 'deposits.manage']);
