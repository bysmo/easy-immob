    ...
    public function run(): void
    {
        ...
        $primaryAgency = Agency::firstOrCreate(
            ...
            [
                ...
                'manager_phone'     => '+226 25 65 92 12 / 05 75 98 25',
                'manager_id_card'   => 'CNIB N°B15795168 du 03/06/2021 par ONI/Ouaga',
                'phone'             => '+226 25 65 92 12',
                'address'           => 'Ouagadougou, Burkina Faso',
                'nif_rccm'          => 'IFU N°00086587W',
        ...
        $secondaryAgency = Agency::firstOrCreate(
            ...
            [
                ...
                'manager_name'      => 'KABORE OUSMANE',
                'manager_title'     => 'Directeur Général',
                'manager_phone'     => '+226 70 20 30 40',
                'manager_id_card'   => 'CNIB N°B98765432 du 12/01/2022 par ONI/Ouaga',
                'phone'             => '+226 25 30 40 50',
                'address'           => 'Ouagadougou, Burkina Faso',
                'nif_rccm'          => 'IFU N°00099887A',
        ...
        $ownersData = [
            [
                ...
                'last_name'      => 'CONGO',
                'company_name'   => null,
                'email'          => 'mohamed.congo@gmail.com',
                'phone'          => '+226 70 22 71 22',
                'address'        => 'Ouagadougou, Burkina Faso',
                'profession'     => 'Employé de commerce',
                'nationality'    => 'Burkinabè',
                'id_card_number' => 'CNIB N°B15795168 du 03/06/2021 par ONI/Ouaga',
            ],
            [
                'reference'      => 'PRO-0002',
                ...
                'phone'          => '+226 76 12 23 34',
                'address'        => 'Ouaga 2000, Ouagadougou',
                'profession'     => 'Médecin',
                'nationality'    => 'Burkinabè',
                'id_card_number' => 'CNIB N°B12345678 du 10/05/2020 par ONI/Ouaga',
            ],
            [
                'reference'      => 'PRO-0003',
                'first_name'     => 'Kouassi',
                ...
                'id_card_number' => 'CNI N°C0099887766',
            ],
            [
                'reference'      => 'PRO-0004',
                'first_name'     => 'Yves',
                ...
                'nationality'    => 'Ivoirienne',
                'id_card_number' => 'CNI N°C0011223344',
            ],
            [
                'reference'      => 'PRO-0005',
                'first_name'     => 'Chantal',
                ...
                'nationality'    => 'Ivoirienne',
                'id_card_number' => 'CNI N°C0055667788',
            ],
            [
                'reference'      => 'PRO-0006',
                'first_name'     => 'Seydou',
                ...
                'nationality'    => 'Ivoirienne',
                'id_card_number' => 'CNI N°C0022334455',
            ],
        ];
        ...
        $tenantsData = [
            [
                ...
                'first_name'        => 'MARIAM',
                'last_name'         => 'COMPAORE',
                'email'             => 'mariam.compaore@gmail.com',
                'phone'             => '+226 77 02 32 32',
                'address'           => 'Ouaga 2000, Ouagadougou',
                'profession'        => 'Secrétaire de Direction',
                'nationality'       => 'Burkinabè',
                'id_card_number'    => 'CNIB N°B18203984 du 05/04/2023 par ONI/Ouaga',
                'emergency_contact' => 'M. Compaoré Ousmane (Frère) - +226 70 00 11 22',
            ],
            [
                'reference'         => 'LOC-0002',
                'first_name'        => 'Fatou',
                ...
                'nationality'       => 'Ivoirienne',
                'id_card_number'    => 'CNI N°C0088776655',
            ...
            [
                ...
                'nationality'       => 'Ivoirienne',
                'id_card_number'    => 'CNI N°C0033445566',
            ...
            [
                ...
                'nationality'       => 'Ivoirienne',
                'id_card_number'    => 'CNI N°C0044556677',
            ...
            [
                ...
                'nationality'       => 'Ivoirienne',
                'id_card_number'    => 'RCCM CI-ABJ-2023-B-1234',
        ...
        // Mois concernés: 2026-04, 2026-05, 2026-06, 2026-07, 2026-08, 2026-09, 2026-10, 2026-11
        $periods = [
            '2026-04' => '2026-04-05',
            '2026-05' => '2026-05-05',
            '2026-06' => '2026-06-05',
